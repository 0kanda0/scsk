...
public class OVRLipSyncContextMorphTarget : MonoBehaviour
{
    ...
    void LateUpdate ()
    {
        if((lipsyncContext != null) && (skinnedMeshRenderer != null))
        {
            ...
            if (frame != null)
            {
                ...
                //EmossionControl(30,30,30,30,30);
            }
    ...
    public void EmotionControl(int fun,int sorrow, int angry, int joy, int surprised)
    {
        skinnedMeshRenderer.SetBlendShapeWeight(0,fun);
        skinnedMeshRenderer.SetBlendShapeWeight(1, sorrow);
        skinnedMeshRenderer.SetBlendShapeWeight(2,angry);
        skinnedMeshRenderer.SetBlendShapeWeight(3,joy);
        skinnedMeshRenderer.SetBlendShapeWeight(4, surprised);
    }
